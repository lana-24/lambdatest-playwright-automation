...
| CHK-09 | Checkout | Checkout with empty cart                                  | show error text: "Your shopping cart is empty!"                                |
| CHK-10 | Checkout | Checkout with invalid telephone number (guest account)    | show error text: "Telephone must be between 3 and 32 characters!"              |
| CHK-11 | Checkout | Checkout with password confirmation mismatch              | show error text: "Password confirmation does not match password!" text:        |
| CHK-12 | Checkout | Checkout with phone number contains letters/simbols       | show error text: "Phone number phone numbers must not contain symbols"         |
| CHK-13 | Checkout | Checkout with empty address (guest account)               | show error text: "Address 1 must be between 3 and 128 characters!"             |
