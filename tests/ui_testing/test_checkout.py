...
def test_checkout_guest_account(page):
    ...
    checkout_page.fill_fname_lname(TestData.first_name(), TestData.last_name())
    ...
    checkout_confirm_page = checkout_page.click_continue()
...
def test_checkout_login_account(page):
    ...
    checkout_page.fill_login(EMAIL, PASSWORD)
